...
@onready var unstuck_btn: Button = %UnstuckBtn
@onready var how_to_play_btn: Button = %HowToPlayBtn
...
func _apply_styles() -> void:
	...
	ui_ctrl.apply_button_style(unstuck_btn)
	ui_ctrl.apply_button_style(how_to_play_btn)
