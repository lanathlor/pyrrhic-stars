# Arcanotechnicien — Ability Codex

Complete ability list. Each ability has a School, Type, Flux cost, commit behavior, and effect.

Delivery column (for healing/support abilities): **Z**one, **B**eam, **D**irect, or **—** for non-healing.

Abilities marked **NEW** are additions addressing identified design gaps.

---

## Fire

| Ability    | Type        | Cost   | Commit                  | Delivery | Effect                                                                                                                     |
| ---------- | ----------- | ------ | ----------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------- |
...
| Gale Shield   | Protection   | Medium | Instant                 | —        | Wind barrier around channeler (4s). Deflects projectiles, reduces ranged damage. Melee unaffected.   |
...
| Force Shell         | Protection  | Medium  | Instant | —        | Gravity field around channeler (3s). Deflects projectiles, reduces melee damage taken. No AoE protection. |
...
| Ability                       | Type        | Cost   | Commit  | Delivery | Effect                                                                                                                                                                                        |
| ----------------------------- | ----------- | ------ | ------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mending Surge                 | Enhancement | High   | Instant | D        | Massive single-target heal. Biggest heal per commit in the game. Burns Flux fast.                                                                                                             |
...
| Neural Fortification          | Protection  | High   | Instant | —        | Buff target ally (6s): +20% DR, immune to one interrupt. "Protect the channeler" ability.                                                                                                     |
...
| Vital Drain          | Destruction | Medium | Channel | —        | Tether to enemy. Drains HP/tick, heals channeler for portion dealt. Self-sustain for DPS specs.                                                                                                                                   |
| Metabolic Disruption | Affliction  | Medium | Instant | —        | Debuff target: -15% healing received, -10% move speed (8s). PvP tool / niche PvE.                                                                                                                                                |
| **NEW** Vital Bloom  | Enhancement | Low    | Instant | Z        | Sacrifices a portion of channeler's HP to create healing zone at target (8s). Heal/tick proportional to HP sacrificed. Self-sacrifice Zone — more HP given, stronger zone. The Biometabolic primary-school Zone heal.             |
| **NEW** Siphon Pulse | Destruction | Low    | Instant | —        | Minor damage to target enemy. If target has any debuff, heals nearest injured ally for portion of damage. Offensive filler that feeds Confluence and trickle-heals. The "safe phase" ability.                                     |
| **NEW** Last Breath  | Enhancement | High   | Instant | D        | 60s cooldown. Target ally cannot die for 4 seconds — lethal damage reduces to 1 HP. When effect expires, channeler takes 50% of prevented damage as self-damage. The emergency cooldown — save someone, pay for it yourself.      |
...
| Ability        | Type        | Cost    | Commit  | Delivery | Effect                                                                                                       |
| -------------- | ----------- | ------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------ |
| Flux Negation  | Protection  | High    | Instant | —        | Dispels one Flux-based effect. Ally: removes debuff. Enemy: removes buff. Counter-arcanotechnique staple.    |
...
## Harmonist Ability Pool Summary

Abilities a Harmonist would realistically consider, organized by role:

### Core Healing

| Ability               | School           | Delivery | Cost | Why bring it                           |
| --------------------- | ---------------- | -------- | ---- | -------------------------------------- |
...
| Ability              | School           | Cost | Why bring it                             |
| -------------------- | ---------------- | ---- | ---------------------------------------- |
