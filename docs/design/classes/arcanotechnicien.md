...
Camera: third person, pulled back for spatial awareness. Input: target-based ability usage, Flux management, spellbook preparation. Core loop: prepare the right loadout, manage Flux throughput, channel at the right moment, avoid interruption.

The Arcanotechnicien is the only class whose combat kit changes between encounters. Where a Gunner always has Overclock and a Vanguard always has their dodge, an Arcanotechnicien selects 6 spells from a codex of ~35 before each fight. Two Destroyers can have completely different loadouts. The pre-fight spellbook is half the skill — the other half is executing under pressure while your team keeps you alive.
...
| ------------------ | ------------------ | ---------------------------------------------------------------------- |
| Destroyer          | Glass cannon       | Huge Flux reserve, massive spells, long channels, vulnerable           |
| Battlemage         | Melee-range hybrid | Lower Flux, instant combat spells, weaves strikes with arcanotechnique |
...
If a spell's cost <= your Afflux per Tick, the spell fires instantly. If a spell costs more than your Afflux, you must **channel** — standing still, visibly gathering Flux, vulnerable to interruption. Channel duration = spell cost / Afflux per Tick (rounded up to whole ticks).

Channeling is visible to every player in the zone. A glowing Flux accumulation builds around the caster, scaling in intensity with channel progress. This creates the organic "protect the caster" dynamic — allies can see when a big spell is building and position accordingly.

**Interruption**: any damage or hard CC during a channel cancels it. Half the accumulated Flux is lost. The other half returns to reserve. Getting interrupted on a 3-second Cataclysm doesn't just waste time — it burns a chunk of your reserve for nothing.

**Early Release**: some channeled spells (marked in the codex) support early release — you can fire the spell before the channel completes for proportional effect. A Fireball released at 70% channel deals ~70% damage. This adds skill expression: holding to the absolute last tick before a telegraph hits, or releasing early to save yourself. Not all spells support this — Cataclysm-type spells are all-or-nothing.
...
Each school has a clear identity. Knowing what a school does tells you what its spells will feel like in combat. Schools are grouped by the nature of their Flux conversion.
...
| **Pure**     | Raw Flux manipulation — acts on arcanotechnology itself without channeling through a physical phenomenon                 | Spell negation, Flux burn, dispel, amplification. No effect on physical matter. The most versatile and most difficult school. The "counter-magic" school. |
...
Each spec has **primary** and **secondary** school affinities. Primary schools have full effectiveness — spells cost base Flux and channel at base speed. Secondary schools work but at +25% Flux cost. Schools outside your affinity are accessible but at +50% cost — worth it for niche utility, punishing for core rotation.
...
All specs can access Pure as a secondary school — counter-magic is a core Arcanotechnicien skill regardless of spec.

---

## The Codex (Spellbook)

The Arcanotechnicien's codex contains ~40 spells across all schools. Before combat (at rest areas, between encounters), you prepare a **loadout of 6 spells** from the codex. These are your combat abilities for the next fight.

### Spell Types

Every spell has a School (which element) and a Type (what it does mechanically):
...
-   **6 spell slots** — your full combat kit. Choose wisely.
-   **School affinity applies** — off-affinity spells cost more Flux (see above).
-   **No duplicate types required** — you can bring 6 Destruction spells if you want. You'll have zero utility, but you can.
...
Every other class walks into every fight with the same abilities. The Arcanotechnicien walks in with a hypothesis: "This boss has a burn phase at 30%, so I'm bringing two Frost control spells to survive it, plus three Fire nukes for the opening, and a Gravitonic pull for the add wave."
...
**Example**: a Destroyer bringing 3 Fire spells and 3 Frost spells might commit 60% Fire / 40% Frost. This means:

-   60% of Flux Reserve is available for Fire spells, regenerates at 60% of natural recovery rate
-   40% of Flux Reserve is available for Frost spells, regenerates at 40% of natural recovery rate
...
Commitment is set alongside your loadout at rest areas. Part of the same pre-fight preparation. The loadout answers "what can I cast?" and commitment answers "how much can I cast of each?"
...
**Building Confluence**: each successfully completed spell (instant or fully channeled) adds 1 stack. Max 5 stacks.

**Confluence effects** (per stack):

-   +8% spell power (damage, healing, zone size, buff strength)
-   -3% channel time on channeled spells
-   Visual escalation: Flux particles orbit the caster, growing denser and brighter per stack

**Losing Confluence**: getting interrupted drops ALL stacks to zero. Not casting for ~4 seconds begins a 1-stack-per-second decay. Taking damage does NOT drop stacks (only interruption does) — you can eat hits and maintain Confluence as long as you're not mid-channel when they land.

**The Tension**: Confluence rewards sustained casting. But sustained casting means sustained vulnerability. A Destroyer at 5 stacks is dealing 40% bonus damage — but they've been standing still channeling for 10+ seconds to get there. The team has been protecting them. One interrupt resets everything.
...
Massive AoE burst. Glass cannon. The skill is finding safe windows to channel devastating spells without getting interrupted.

### Core Mechanic: Overcharge

Channeled spells can be **held past their completion point**. Once a channel completes, you enter Overcharge — continuing to hold pours additional Flux into the spell, increasing its damage, AoE radius, or duration beyond base values.

Overcharge builds Instability. A visible meter fills as you hold. Release the spell during the **safe window** (the green zone on the meter, scaled by Mastery) for maximum bonus damage. Hold past the safe window into the **red zone** and the spell destabilizes — reduced damage, self-damage from Flux backlash, and a brief casting lockout.
...
When a Destroyer completes a channeled spell (with or without Overcharge), their next spell within 3 seconds gains **Cataclysm Resonance** — increased AoE radius (+30%) and a brief channel speed bonus. This chains big spells together: finish a Fireball, immediately begin a Frost Nova with wider radius and faster channel.

Cataclysm Resonance is what makes Destroyer feel like a cascading avalanche of destruction. Each completed spell accelerates the next one. But the chain breaks instantly on interruption — you lose Confluence AND the Resonance bonus.
...
The rhythm is: **channel → overcharge → release → chain → channel → overcharge → release**. Safe windows between boss mechanics are your DPS windows. Dangerous phases are for repositioning, instant spells, and shield uptime.

### Skill Expression

-   **Beginner**: channels spells to base completion without Overcharging, releases immediately. Never builds Confluence past 2 stacks because they stop casting to dodge telegraphs. Uses Frost Ward reactively after taking damage. Still deals respectable burst — the spells hit hard at baseline.
-   **Competent**: Overcharges into the safe window reliably. Maintains 3-4 Confluence stacks by chaining spells during openings. Pre-positions at range to minimize interrupt risk. Manages Flux commitment to never run dry on their primary school mid-fight.
-   **Expert**: Overcharges to the edge of the safe window for maximum bonus on every channeled spell. Maintains 5 Confluence stacks through entire fight phases by threading channels between telegraphs. Chains Cataclysm Resonance across 3-4 spells in a single burst window. Early-releases spells at the exact moment needed to dodge, preserving Confluence. Swaps loadouts between pulls to optimize for each encounter's AoE patterns. The team builds around protecting them during channel sequences.
...
Melee-range hybrid. Monotarget, constant damage. The skill is maintaining a perfect rhythm of alternating weapon strikes and spells without breaking the chain.

### Core Mechanic: Weave

Alternating between a **melee weapon strike** and a **spell** grants a stacking damage bonus (max 8 stacks, scaled by Mastery). Each alternation adds a stack. Two consecutive melee strikes or two consecutive spells break the chain and reset stacks to zero.

The rhythm is strict: strike → spell → strike → spell. At 8 stacks, every hit (weapon or spell) deals significant bonus damage. The Mastery stat (Weave) scales the per-stack bonus and adds a brief grace period between actions before the chain breaks.

Weave transforms the Arcanotechnicien from a stationary caster into a melee combatant who happens to use magic. You're in the boss's face, sword in one hand, Flux crackling in the other, alternating between physical and arcane damage in a relentless rhythm.
...
The Flux Blade has a 3-hit combo: lateral slash → upward cut → thrust. Each hit in the combo is slightly slower but deals more damage. You don't need to complete the combo — any single hit counts as a "strike" for Weave purposes. But completing the full 3-hit combo before the next spell grants a small bonus to the spell's damage (momentum carry).

### Innate: Close Quarters

Spells cast within melee range (5m of target) have their channel time reduced by 50%. Spells that would normally require channeling at range become instant or near-instant in melee. This is the mechanic that makes Battlemage work — you're not a caster who sometimes melees, you're a melee fighter whose spells are instant because you're always in the enemy's face.

Close Quarters does NOT reduce Flux cost — only channel time. Expensive spells are still expensive. You'll drain your reserve faster than a Destroyer because you're casting more frequently (every other GCD), even though each individual spell costs less than a Destroyer's Overcharged nukes.
...
Combat feels aggressive and rhythmic. The Flux Blade crackles with electricity on each swing. Spells fire from the off-hand in quick bursts between strikes — a Lightning Blade infuses the weapon, a Static Discharge arcs from your palm mid-combo, a Shadow Step repositions you behind the boss. The fantasy is a warrior-mage in constant, fluid motion.
...
The rhythm is a metronome: **strike-spell-strike-spell**. Boss mechanics that force you to stop swinging (long dodges, phase transitions, forced range) are your enemy — they break Weave. Mechanics that you can dodge through while maintaining melee range are opportunities.

### Skill Expression

-   **Beginner**: alternates strike and spell loosely, maintains 2-3 Weave stacks. Uses spells at range, missing Close Quarters bonus. Breaks the chain frequently by double-striking or panicking into consecutive dodges. Still deals decent damage — the weapon hits hard and the spells are instant at melee range.
-   **Competent**: maintains 5-6 Weave stacks reliably. Weaves dodges into the strike-spell rhythm without breaking the chain. Uses Shadow Step to stick to repositioning bosses. Manages Flux to never run dry mid-chain. Consistent, relentless DPS.
-   **Expert**: maintains 8 Weave stacks through entire fight phases. Times full Flux Blade combos to land the 3-hit bonus on key spells. Weaves dodges, repositioning, and defensive abilities into the rhythm without ever double-striking or double-casting. Pre-positions so boss mechanics don't force range. The Weave chain becomes unconscious — pure flow state. DPS output is the highest sustained single-target among Arcanotechnicien specs.
...
The punishment is precision. Weave demands perfect alternation. Under pressure — dodging telegraphs, chasing a repositioning boss, managing Flux — maintaining strike-spell-strike-spell becomes genuinely difficult. Breaking the chain at 7 stacks because you panic-dodged into a double-strike is devastating. And unlike Vanguard, you have no parry, no block, and no stamina-based i-frames. Your survival is pure positioning and spell-based mobility.
...
The Harmonist draws from two healing schools that play fundamentally differently. **Bioarcanotechnic** spells are expensive but powerful — massive single-target heals and beams that burn through Flux. **Biometabolic** spells are Flux-cheap but cost ally HP — draining one ally to heal another, redistributing health across the group. The Harmonist's skill is mixing both: Biometabolic for sustain, Bioarcanotechnic for emergencies.

Harmonist healing is channeled and visible, just like offensive Arcanotechnicien spells. Allies must stand in your healing zones or stay near your beams. The Harmonist must be protected during channels. This is not a healer who hides in the back — this is a healer who is the most important target in the fight.
...
-   **Beam** — channeled tether between caster and target, heals while maintained
-   **Direct** — instant or short-cast heal on a specific target
...
**Beams** — channeled connection between you and a target. Highest single-target healing throughput, but locks you in place and requires line-of-sight to the target. The beam is a visible Flux stream — allies can see who you're healing, and enemies can see your commitment. Breaking line-of-sight or getting interrupted ends the beam.

**Direct** — instant or short-cast heal on a target. Lowest throughput but no channel, no positioning requirement beyond range. The emergency tool — someone is about to die and you can't set up a zone or beam in time.
...
The rhythm weaves both schools: **Biometabolic to fuel, Bioarcanotechnic to deliver**. Biometabolic spells are cheap but drain your allies — you're constantly making triage decisions about who can afford to lose HP right now. Bioarcanotechnic spells are expensive but powerful — you use them when someone needs saving NOW and you can't afford to set up a drain. The interplay between the two schools is the Harmonist's unique skill expression.

### Skill Expression

-   **Beginner**: only uses Mending Surge and Mending Beam. Never touches Biometabolic spells (too scary to drain allies). Burns through Flux in 30 seconds and has nothing left. Healing is functional but unsustainable — the "I only know Bioarcanotechnic" Harmonist.
...
Harmonist is the healer that treats the entire party's HP as a shared resource. Biometabolic spells move health around — taking from the healthy to give to the dying, draining one ally to heal the group. Bioarcanotechnic spells are the raw power backup — massive heals that burn through Flux when redistribution isn't enough.
...
## The Codex — Spell List

The full list of spells available to Arcanotechnicien. Each spell belongs to a School and a Type. Flux costs are relative (Low/Medium/High/Extreme) — actual values depend on character level and gear.
...
**Flux Armor** — Protection. Medium cost. Instant. Wraps the caster in a crackling electromagnetic field for 4 seconds. Absorbs incoming damage. Enemies who strike the caster in melee take shock damage. The Battlemage's defensive tool.
...
**Gale Shield** — Protection. Medium cost. Instant. Creates a swirling wind barrier around caster for 4 seconds. Deflects incoming projectiles and reduces ranged damage taken. Melee attacks unaffected.
...
**Force Shell** — Protection. Medium cost. Instant. Surrounds caster in a gravity field for 3 seconds. Incoming projectiles are deflected. Melee attacks against the caster deal reduced damage. Does not prevent telegraphed AoE.
...
Expensive, powerful, monotarget. The "emergency room" school — each spell costs a lot of Flux but hits hard.

**Mending Surge** — Enhancement. High cost. Instant. Massive single-target heal on an ally. The biggest heal in the game per cast. Burns through your Flux reserve fast — you can't spam this, but when someone is about to die, nothing else compares.

**Mending Beam** — Enhancement. High cost. Channeled. Tethers caster to target ally. Heals for a large amount per tick while channeled. Highest sustained single-target healing throughput. Line-of-sight required. Expensive to maintain — drains Flux every tick.
...
**Neural Fortification** — Protection. High cost. Instant. Buffs target ally for 6 seconds: +20% damage reduction, immunity to one interrupt effect. The "protect the caster" spell — a Harmonist can cast this on a Destroyer mid-channel to armor them against one interruption.
...
**Life Swap** — Enhancement. Low cost. Instant. Drains a portion of target ally's HP and stores it as vital charge. The next healing spell you cast within 4 seconds is empowered by the stored charge (bonus healing proportional to HP drained). The core Biometabolic mechanic — take health from someone healthy to supercharge your next heal on someone dying. Allies must trust their Harmonist.

**Transfusion** — Enhancement. Low cost. Channeled. Tethers caster to an ally, draining their HP per tick. Simultaneously heals all other allies within 10m for the same amount. The AoE heal — powered by one ally's sacrifice. Best used on a high-HP Shield Vanguard who can afford to donate. Interruptible.
...
**Vital Drain** — Destruction. Medium cost. Channeled. Tethers caster to target enemy. Drains health per tick, healing the caster for a portion of damage dealt. The self-sustain option for any Arcanotechnicien without a healer. Beam is visible and interruptible.
...
**Vital Bloom** — Enhancement. Low cost. Instant. Sacrifices a portion of the caster's HP to create a healing zone at target location for 8 seconds. Heal per tick is proportional to HP sacrificed — more health given, stronger zone. The Biometabolic primary-school Zone heal. Self-sacrifice fits the school's identity: HP is the currency.

**Siphon Pulse** — Destruction. Low cost. Instant. Deals minor damage to target enemy. If the target has any active debuff, heals the nearest injured ally for a portion of the damage dealt. The Harmonist's offensive filler — builds Confluence during safe phases and trickle-heals as a bonus. Pairs with Frostbite or Burn for sustained damage+heal loops.

**Last Breath** — Enhancement. High cost. Instant. 60-second cooldown. Target ally cannot die for 4 seconds — lethal damage reduces them to 1 HP instead. When the effect expires, the caster takes 50% of the damage that was prevented as self-damage. The emergency cooldown — save someone, pay the price yourself.

### Martial (Battlemage Only)

Martial spells do not consume Flux. They use cooldowns instead — channeling vital energy rather than external Flux. Only accessible to the Battlemage spec.
...
**Flux Negation** — Protection. High cost. Instant. Dispels one active Flux-based effect on target (ally: removes debuff; enemy: removes buff). The counter-magic tool. Essential for encounters with dispellable mechanics.
...
The Arcanotechnicien's universal tension is **preparation and vulnerability**. You walk into every fight with a plan — your loadout, your commitment split, your casting priority. When the plan works, you are the most powerful force on the battlefield: Destroyers erase entire rooms, Battlemages sustain relentless hybrid damage, Harmonists keep parties alive through otherwise lethal mechanics.

When the plan fails — wrong loadout, bad positioning, interrupted at the worst moment — you are helpless. No Flux means no abilities. No channel completion means no damage. No team protection means no safe windows to cast.

Where Gunner asks "can I hit the target?" and Vanguard asks "when do I commit?", the Arcanotechnicien asks "did I prepare correctly, and can I execute the plan?" The skill expression spans two timescales: the strategic (loadout, commitment, spell selection before the fight) and the tactical (channel timing, Overcharge windows, Weave rhythm, Harmony cycling during the fight).

The spellbook is the class's soul. It's what makes two Arcanotechniciens feel completely different. It's what creates the theorycrafting community. It's the answer to "what should I bring for this boss?" that drives endless discussion. And it's the reason the Arcanotechnicien has the highest skill ceiling that isn't purely mechanical — because half the skill happens before you ever enter combat.
