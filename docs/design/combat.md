...
- Every point of damage a boss deals should be avoidable with better play
- No invisible auto-attack damage ticks on a "tank"
- Bosses have baseline pressure: melee swings on nearest player (telegraphed, dodgeable) and ranged projectiles on farthest player (targeted laser, strafeable)
